...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " To take off .~n~~" .. radioConfig.Controls.Toggle.Name .. "~ To ~ g~ open ~s~ the Radio.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ or ~" .. radioConfig.Controls.Increase.Name .. "~ Change frequency ~n~~" .. radioConfig.Controls.Input.Name .. "~ Choose frequency~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ to ~a~ clicks micro~n~Frequency: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " To take off .~n~~" .. radioConfig.Controls.Toggle.Name .. "~ To ~r~close ~s~the Radio.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ To talk: ~ N ~ Frequency: ~1~ MHz" },
...
Radio.Commands = {
	{
		...
		Help = "Activated hand on radio", -- Command help shown in chatbox when typing the command
		Params = {},
	...
	},
	{
		...
		Params = {
			{name = "number", "Enter the frequency"}
		},
		Handler = function(src, args, raw)
			if Radio.Has then
				if args[1] then
	...
	while true do
		...
		if Radio.Open then
			...
			if not Radio.On then
				AddTextComponentSubstringPlayerName(Radio.Clicks and "~r~deactivate~w~" or "~g~activate~w~")
			end
